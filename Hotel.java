...
public class Hotel {
            ...
            for (int i = 0; i < register.size(); i++) {
                ...
                if (register.get(i).contains(option) && !(bookedList.contains(register.get(i).get(1)))) {
                    ...
                    String drink = JOptionPane.showInputDialog("""
                                                               En este menu podras ver todas las opciones disponibles de Habitaciones que los empleados pueden elegir.
                    ...
                    String time = JOptionPane.showInputDialog("""
                                                              Genial!!
                                                              Estamos a un paso de finalizar. Ahora solo debes de seleccionar el momento donde deseas tener la habitacion.
    ...
    public String drinkSelection (String drink) {
        ...
        switch (drink) {
            case "1" -> drinkOption = "Habitacion Comun";
            case "2" -> drinkOption = "Habitacion Deluxe";
            case "3" -> drinkOption = "Habitacion Vip";
            case "4" -> drinkOption = "Habitacion Presidencial";
